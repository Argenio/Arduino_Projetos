 ...
 * Aqui vem algo diferente: como será feita a atualização OTA (usando wi-fi), 
 * é preciso enviar pelo web updater  um arquivo com o programa do ESP32 já compilado. A este arquivo dá-se o nome de binário.
 ...
 * 3 - Será criado na mesma pasta que você salvou o código fonte (esp32_depois_ota.ino) um arquivo chamado Esp32LoRa_OTA_Depois.ino.wifi_lora_32_V2.bin.
 *     Este é o binário que iremos utilizar na página de upload de software no web updater
*/
...
const char* host = "Esp32 LoRa 01";
const char* ssid = "GerenteMax FT - 5.Ghz"; /* coloque aqui o nome da rede wi-fi que o ESP32 deve se conectar */
